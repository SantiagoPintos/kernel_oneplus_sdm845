...
struct nf_conn {
	...
	u32 op_game_up_count;
	u32 op_game_down_count;
	u32 op_game_lost_count;
	u32 op_game_same_count;
	u32 op_http_flag;
	u32 op_skb_count;
	int op_app_type;
	...
	s64 op_game_special_rx_pkt_last_timestamp;
	s64 op_game_special_rx_pkt_interval;
